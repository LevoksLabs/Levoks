...
mongoose.connect(MONGO_URI)
  ...
  .catch((err) => {
    console.error('Service startup failed. Check database and observability configuration.');
    process.exit(1);
  });
...
EXPOSE ${port}
HEALTHCHECK --interval=30s --timeout=5s --start-period=30s --retries=3 CMD ["node", "observability/check.js"]
